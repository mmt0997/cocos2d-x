...
public:
     ...
     */
    BoundingBox(const cocos2d::Vec3& min, const cocos2d::Vec3& max);
     ...
     */
    void getCenter(cocos2d::Vec3* dst) const;
     ...
     */
    void getCorners(cocos2d::Vec3* dst) const;
     ...
     * @param max The maximum point of the bounding box.
     */
    void set(const cocos2d::Vec3& min, const cocos2d::Vec3& max);
     ...
     */
    inline BoundingBox& operator*=(const cocos2d::Mat4& matrix);
};
