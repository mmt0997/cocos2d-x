...
public:
     ...
     */
    BoundingSphere(const cocos2d::Vec3& center, float radius);
     ...
     * @param radius The radius of the sphere.
     */
    void set(const cocos2d::Vec3& center, float radius);
     ...
     */
    inline BoundingSphere& operator*=(const cocos2d::Mat4& matrix);

private:

    float distance(const BoundingSphere& sphere, const cocos2d::Vec3&);

    bool contains(const BoundingSphere& sphere, cocos2d::Vec3* points, unsigned int count);
};
