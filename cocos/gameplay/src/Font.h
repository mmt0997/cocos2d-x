...
public:
     ...
     */
    void drawText(const char* text, int x, int y, const cocos2d::Vec4& color, unsigned int size = 0,
     ...
     */
    void drawText(const char* text, const Rectangle& area, const cocos2d::Vec4& color, unsigned int size = 0,
     ...
     */
    int getIndexAtLocation(const char* text, const Rectangle& clip, unsigned int size,const cocos2d::Vec2& inLocation,
                          cocos2d::Vec2* outLocation, Justify justify = ALIGN_TOP_LEFT, bool wrap = true, bool rightToLeft = false);

    /**
     * Get the location of the character at the given index.
     */
    void getLocationAtIndex(const char* text, const Rectangle& clip, unsigned int size,cocos2d::Vec2* outLocation,
...
private:
    ...
    int getIndexOrLocation(const char* text, const Rectangle& clip, unsigned int size,const cocos2d::Vec2& inLocation,cocos2d::Vec2* outLocation,
    ...
    int handleDelimiters(const char** token, const unsigned int size, const int iteration, const int areaX, int* xPos, int* yPos, unsigned int* lineLength,
                        ...
                        const cocos2d::Vec2* stopAtPosition = NULL, const int currentIndex = -1, const int destIndex = -1);
