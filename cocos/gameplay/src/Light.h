...
public:
     ...
     * @script{create}
     */
    static Light* createDirectional(const cocos2d::Vec3& color);
     ...
     * @script{create}
     */
    static Light* createPoint(const cocos2d::Vec3& color, float range);
     ...
     * @script{create}
     */
    static Light* createSpot(const cocos2d::Vec3& color, float range, float innerAngle, float outerAngle);
     ...
     */
    const cocos2d::Vec3& getColor() const;
     ...
     */
    void setColor(const cocos2d::Vec3& color);
...
private:
    ...
    public:
        ...
        Directional(const cocos2d::Vec3& color);
    };
    ...
    public:
        ...
        Point(const cocos2d::Vec3& color, float range);
    };
    ...
    public:
        ...
        Spot(const cocos2d::Vec3& color, float range, float innerAngle, float outerAngle);
    };

    /**
     * Constructor for the directional light.
     */
    Light(Light::Type type, const cocos2d::Vec3& color);

    /**
     * Constructor for point light.
     */
    Light(Light::Type type, const cocos2d::Vec3& color, float range);

    /**
     * Constructor for spot light.
     */
    Light(Light::Type type, const cocos2d::Vec3& color, float range, float innerAngle, float outerAngle);
