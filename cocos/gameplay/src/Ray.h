...
public:
     ...
     */
    Ray(const cocos2d::Vec3& origin, const cocos2d::Vec3& direction);
     ...
     */
    const cocos2d::Vec3& getOrigin() const;
     ...
     */
    void setOrigin(const cocos2d::Vec3& origin);
     ...
     */
    const cocos2d::Vec3& getDirection() const;
     ...
     */
    void setDirection(const cocos2d::Vec3& direction);
     ...
     * @param direction The ray's direction.
     */
    void set(const cocos2d::Vec3& origin, const cocos2d::Vec3& direction);
     ...
     */
    void transform(const cocos2d::Mat4& matrix);
     ...
     */
    inline Ray& operator*=(const cocos2d::Mat4& matrix);
...
private:
    ...
    cocos2d::Vec3 _origin;        // The ray origin position.
    cocos2d::Vec3 _direction;     // The ray direction vector.
};
