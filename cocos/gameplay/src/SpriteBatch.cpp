...
SpriteBatch* SpriteBatch::create(Texture* texture,  Effect* effect, unsigned int initialCapacity)
{
    ...
    cocos2d::Mat4::createOrthographicOffCenter(0, game->getViewport().width, game->getViewport().height, 0, 0, 1, &batch->_projectionMatrix);
...
void SpriteBatch::draw(const Rectangle& dst, const Rectangle& src, const cocos2d::Vec4& color)
{
    // Calculate uvs.
...
void SpriteBatch::draw(const cocos2d::Vec3& dst, const Rectangle& src,const cocos2d::Vec2& scale, const cocos2d::Vec4& color)
{
    // Calculate uvs.
    float u1 = _textureWidthRatio * src.x;
    float v1 = 1.0f - _textureHeightRatio * src.y;
...
void SpriteBatch::draw(const cocos2d::Vec3& dst, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color,
...
void SpriteBatch::draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color,
         const cocos2d::Vec2& rotationPoint, float rotationAngle, bool positionIsCenter)
{
...
void SpriteBatch::draw(const cocos2d::Vec3& position, const cocos2d::Vec3& right, const cocos2d::Vec3& forward, float width, float height,
    float u1, float v1, float u2, float v2, const cocos2d::Vec4& color,const cocos2d::Vec2& rotationPoint, float rotationAngle)
{
    // Calculate the vertex positions.
    cocos2d::Vec3 tRight(right);
    tRight *= width * 0.5f;
    cocos2d::Vec3 tForward(forward);
    tForward *= height * 0.5f;
    
    cocos2d::Vec3 p0 = position;
    p0 -= tRight;
    p0 -= tForward;

    cocos2d::Vec3 p1 = position;
    p1 += tRight;
    p1 -= tForward;
    ...
    if (rotationAngle != 0)
    {
        ...
        static cocos2d::Vec3 u;
        cocos2d::Vec3::cross(right, forward, &u);
        static cocos2d::Mat4 rotation;
        cocos2d::Mat4::createRotation(u, rotationAngle, &rotation);
        p0 -= rp;
        p0 *= rotation;
        p0 += rp;
        p1 -= rp;
...
void SpriteBatch::draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color)
{
    draw(x, y, 0, width, height, u1, v1, u2, v2, color);
}

void SpriteBatch::draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip)
{
    draw(x, y, 0, width, height, u1, v1, u2, v2, color, clip);
}

void SpriteBatch::draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip)
{
...
void SpriteBatch::addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, SpriteBatch::SpriteVertex* vertices)
{
    GP_ASSERT(vertices);
...
void SpriteBatch::addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip, SpriteBatch::SpriteVertex* vertices)
{
    GP_ASSERT(vertices);
...
void SpriteBatch::draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, bool positionIsCenter)
{
    // Treat the given position as the center if the user specified it as such.
    if (positionIsCenter)
    {
...
void SpriteBatch::setProjectionMatrix(const cocos2d::Mat4& matrix)
{
    _projectionMatrix = matrix;
}

const cocos2d::Mat4& SpriteBatch::getProjectionMatrix() const
{
