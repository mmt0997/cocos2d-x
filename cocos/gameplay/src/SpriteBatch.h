...
public:
     ...
     */
    void draw(const Rectangle& dst, const Rectangle& src, const cocos2d::Vec4& color = cocos2d::Vec4::ONE);
     ...
     * @param color The color to tint the sprite. Use white for no tint.
     */
    void draw(const cocos2d::Vec3& dst, const Rectangle& src,const cocos2d::Vec2& scale, const cocos2d::Vec4& color = cocos2d::Vec4::ONE);
     ...
     */
    void draw(const cocos2d::Vec3& dst, const Rectangle& src,const cocos2d::Vec2& scale, const cocos2d::Vec4& color,
     ...
     */
    void draw(const cocos2d::Vec3& dst, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color,
     ...
     * @param positionIsCenter Specified whether the given destination is to be the center of the sprite or not (if not, it is treated as the bottom-left).
     */
    void draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color,
             const cocos2d::Vec2& rotationPoint, float rotationAngle, bool positionIsCenter = false);
     ...
     * @param rotationAngle The rotation angle in radians.
     */
    void draw(const cocos2d::Vec3& position, const cocos2d::Vec3& right, const cocos2d::Vec3& forward, float width, float height, 
     ...
     * @param color The color to tint the sprite. Use white for no tint.
     */
    void draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color);
     ...
     */
    void draw(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip);
     ...
     * @param clip The clip rectangle.
     */
    void draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip);
     ...
     * @param positionIsCenter Specified whether the given destination is to be the center of the sprite or not (if not, it is treated as the bottom-left).
     */
    void draw(float x, float y, float z, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, bool positionIsCenter = false);
...
private:
     ...
     * @param vertices The vertices to draw.
     */
    void addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, SpriteBatch::SpriteVertex* vertices);
     ...
     * @param vertices The vertices to draw.
     */
    void addSprite(float x, float y, float width, float height, float u1, float v1, float u2, float v2, const cocos2d::Vec4& color, const Rectangle& clip, SpriteBatch::SpriteVertex* vertices);
    ...
    mutable cocos2d::Mat4 _projectionMatrix;
};
