...
public:
     ...
     */
    inline void transformPoint(Vec3* point) const { CCASSERT(point, ""); transformVector(point->x, point->y, point->z, 1.0f, point); }
     ...
     */
    inline void transformPoint(const Vec3& point, Vec3* dst) const { CCASSERT(dst, ""); transformVector(point.x, point.y, point.z, 1.0f, dst); }
